...
const Notice = () => {
    ...
    useEffect(() => {
        const fetchNotice = async () => {
            ...
            //     return
            // }
            const res = await fetch('https://project-skool-mis-api.vercel.app/api/notice/from/' + user._id, {
    ...
    const sendMessage = async (event) => {
        ...
        // if (event.key === "Enter") {
        try {
            const res = await fetch('https://project-skool-mis-api.vercel.app/api/notice/convey_notice', {
                method: "POST",
