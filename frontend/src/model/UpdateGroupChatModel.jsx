...
const UpdateGroupChatModel = ({ user, selectedChat, setSelectedChat, fetchAgain, setFetchAgain, fetchMessages }) => {
    ...
    const handleRemove = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put('https://my-project-mis-api.onrender.com/api/chat/remove_user', {
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            const { data } = await axios.put('https://my-project-mis-api.onrender.com/api/chat/rename', {
    ...
    const handleAddUser = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put(`https://my-project-mis-api.onrender.com/api/chat/add_user`, {
                chatId: selectedChat._id,
                userId: user1._id,
            }, config
            )
