...
export const MoreStudentResult = ({ studentItem }) => {
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch('https://project-skool-mis-api.vercel.app/api/result/' + studentItem._id, {
            method: 'DELETE',
            headers: {
                ...
                <Table width='100%' backgroundColor='blackAlpha.900'>
                    <Thead width='100%'>
                        <Tr display='flex' width='100%' justifyContent='space-around' px={1} backgroundColor='blue.100'>
                            ...
                            <Th py={1} px={4} width={['160px', '100%', '25%']} display='flex' justifyContent='start' fontSize={['9', '12', '14']} overflow='hidden' textOverflow='ellipsis' wordBreak='break-all'>
                                <Box width='100%'>
                                    Exams
                                </Box>
                            </Th>
                            <Th py={1} px={4} width={['170px', '100%', '27%']} display='flex' justifyContent='start' fontSize={['9', '12', '14']} overflow='hidden' textOverflow='ellipsis' wordBreak='break-all'>
                                <Box width='100%'>
                                    Practical
                                </Box>
                            </Th>
                            <Th py={1} px={4} width={['180px', '100%', '20%']} display='flex' justifyContent='start' fontSize={['9', '12', '14']} overflow='hidden' textOverflow='ellipsis' wordBreak='break-all'>
                                <Box width='100%'>
                                    Score
                                </Box>
                            </Th>
